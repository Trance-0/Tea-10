"""
code build from: https://www.geeksforgeeks.org/red-black-tree-in-python/
"""
# class to implement node of RB Tree
class RBNode:
    # cnostructor, True for red node
